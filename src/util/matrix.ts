...
export const M4 = {
  ...
  subtractVectors: (a: Vector3, b: Vector3): Vector3 => {
  ...
  lookAt: (cameraPosition: Vector3, target: Vector3, up: Vector3): Matrix4 => {
  ...
  transformVector: (m: Matrix4, v: Vector4): Vector4 => {
  ...
  transformPoint: (m: Matrix4, v: Vector3, dst?: Vector3): Vector3 => {
    dst = dst || [0, 0, 0];
    const v0 = v[0];
    const v1 = v[1];
    const v2 = v[2];
  ...
  transformDirection: (m: Matrix4, v: Vector3, dst?: Vector3): Vector3 => {
    dst = dst || [0, 0, 0];
    const v0 = v[0];
    const v1 = v[1];
    const v2 = v[2];
